...
public class HBaseHashOutputSequence {

	public static class HBaseToHdfsSequenceMapper extends TableMapper<Text,Text>{
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		job.setJarByClass(HBaseHashOutputSequence.class);
		job.setMapperClass(HBaseToHdfsSequenceMapper.class);
		...
		TableMapReduceUtil.initTableMapperJob(args[0],new Scan(),HBaseToHdfsSequenceMapper.class, Text.class,Text.class, job);
